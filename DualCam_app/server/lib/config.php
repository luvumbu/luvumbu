...
// Dossier de stockage PROPRE à DualCam (indépendant de PhotoSync).
// Créé automatiquement par install.php, doit être inscriptible.
...
define('DB_PREFIX', $dbConf['prefix'] ?? 'dualcam_');
