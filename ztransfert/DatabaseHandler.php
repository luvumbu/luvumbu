...
// PHP 8.1+ : mysqli lève des exceptions par défaut. Ce code gère les erreurs
// manuellement (tests connect_error, etc.), on rétablit donc l'ancien comportement
// (avertissements au lieu d'exceptions fatales) pour éviter les écrans blancs/noirs.
...
class DatabaseHandler
{
    ...
    function __construct($username, $password)
    {
        ...
        if ($this->connection->connect_error) {
            ...
            // Create database
            $sql = "CREATE DATABASE IF NOT EXISTS $name_bdd";
