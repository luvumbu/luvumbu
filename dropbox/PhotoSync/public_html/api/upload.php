...
$db->prepare(
    'INSERT INTO ' . TBL_PHOTOS . ' (user_id, sha256, original_name, stored_path, size_bytes, taken_at, source)
     VALUES (?,?,?,?,?,?,?)'
)->execute([$uid, $sha, $name, $rel, $size, $dt ? $dt->format('Y-m-d H:i:s') : null, $source]);
