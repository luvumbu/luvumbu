-- ============================================================
-- HR Consulting — Tables à importer dans une base DÉJÀ EXISTANTE
-- (hébergement type Hostinger : base u489596434_hr déjà créée).
-- Dans phpMyAdmin : sélectionne ta base, onglet "Importer", ce fichier.
-- PAS de CREATE DATABASE / USE ici (interdit sur l'hébergement partagé).
-- ============================================================
